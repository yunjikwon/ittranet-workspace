      ...
      document.addEventListener('DOMContentLoaded', function() {
      	  ...
      	  $.ajax({
      		  ...
      		  success:function(calendarList){
      			  ...
      			  console.log(result[1].planContent);
      			  */
      			  ...
      			  for(let i in calendarList) {
      				  eventArr.push( // 위의 빈 배열에 push메소드로 각 행들 삽입
      					  {
      						  title:calendarList[i].planContent,
      	    			  	  start:calendarList[i].planStart,
      	    			  	  end:calendarList[i].planEnd,
      	    			  	  color:calendarList[i].planColor
      					  }
      				  )
      			  }
